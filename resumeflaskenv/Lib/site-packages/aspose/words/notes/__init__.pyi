...
class Footnote(aspose.words.InlineStory):
    ...
    **Footnote** can contain **Paragraph** and **Table** child nodes.'''
    ...
    def is_auto(self) -> bool:
        ...
        :attr:`Footnote.reference_mark` initialized with empty string if IsAuto set to false.'''
        ...
    ...
    def reference_mark(self) -> str:
        ...
        If this property is set to **empty string** (System.String.Empty) or null, then :attr:`Footnote.is_auto` property will automatically be set to true,
