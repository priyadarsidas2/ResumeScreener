...
class Shape(aspose.words.drawing.ShapeBase):
    ...
    def signature_line(self) -> aspose.words.drawing.SignatureLine:
        '''Gets :attr:`Shape.signature_line` object if the shape is a signature line. Returns **null** otherwise.
        
        You can insert new SignatureLines into the document using :meth:`aspose.words.DocumentBuilder.insert_signature_line` and'''
        ...
    
    @property
    def has_chart(self) -> bool:
        '''Returns true if this Shape has a :attr:`Shape.chart`.'''
        ...
    ...
    def chart(self) -> aspose.words.drawing.charts.Chart:
        ...
        This property will return the :attr:`Shape.chart` object only if :attr:`Shape.has_chart`
...
class ShapeBase(aspose.words.CompositeNode):
    ...
    def aspect_ratio_locked(self) -> bool:
        ...
        The default value depends on the :attr:`ShapeBase.shape_type`, for the ShapeType.Image it is **true**
