...
class FieldComments(aspose.words.fields.Field):
    ...
    Retrieves, and optionally sets, the comments relating to the current document, as recorded in the **Comments** property
...
class FieldOptions:
    ...
    def field_update_culture_provider(self) -> aspose.words.fields.IFieldUpdateCultureProvider:
        ...
        The provider is requested when the value of :attr:`FieldOptions.field_update_culture_source` is **FieldUpdateCultureSource.FieldCode**.
...
class FormField(aspose.words.SpecialChar):
    ...
    **FormField** is represented in a document by a special character and
    ...
    def set_text_input_value(self, new_value: object) -> None:
        ...
        The :attr:`FormField.text_input_default` value is applied if  is``null``.'''
        ...
