...
class Body(aspose.words.Story):
    ...
    **Body** is a section-level node and can only be a child of **Section**.
    ...
    def accept(self, visitor: aspose.words.DocumentVisitor) -> bool:
        ...
        :returns: True if all nodes were visited; false if DocumentVisitor stopped the operation before visiting all nodes.
...
class CommentRangeEnd(aspose.words.Node):
    ...
    def __init__(self, doc: aspose.words.DocumentBase, id: int):
        ...
        yet part of the document and :attr:`Node.parent_node` is null.
...
class CompositeNode(aspose.words.Node):
    ...
    * Provides methods for XPath navigation.'''
    ...
    def get_child(self, node_type: aspose.words.NodeType, index: int, is_deep: bool) -> aspose.words.Node:
        ...
        :returns: The child node that matches the criteria or null if no matching node is found.
        ...
        is wrapped in a StructuredDocumentTag, it will still be returned by GetChild(NodeType.Run, 0, false).'''
        ...
    ...
    def select_single_node(self, xpath: str) -> aspose.words.Node:
        ...
        :param xpath: The XPath expression.
        :returns: The first Node that matches the XPath query or null if no matching node is found.'''
        ...
    ...
    def insert_after(self, new_child: aspose.words.Node, ref_child: aspose.words.Node) -> aspose.words.Node:
        ...
        :param ref_child: The Node that is the reference node. The newNode is placed after the refNode.
    ...
    def insert_before(self, new_child: aspose.words.Node, ref_child: aspose.words.Node) -> aspose.words.Node:
        ...
        :param new_child: The Node to insert.
        :param ref_child: The Node that is the reference node. The newChild is placed before this node.
        :returns: The inserted node.'''
        ...
    ...
    def child_nodes(self) -> aspose.words.NodeCollection:
        ...
        Note, :attr:`CompositeNode.child_nodes` is equivalent to calling ``GetChildNodes(NodeType.Any, false)``
...
class Document(aspose.words.DocumentBase):
    ...
    * The formatting attributes of each node can be changed via the properties of that node.
    ...
    def __init__(self, file_name: str, load_options: aspose.words.loading.LoadOptions):
        ...
        :param file_name: File name of the document to open.
        :param load_options: Additional options to use when loading a document. Can be null.
        :raises UnsupportedFileFormatException: The document format is not recognized or not supported.
        :raises FileCorruptedException: The document appears to be corrupted and cannot be loaded.
        :raises System.Exception: There is a problem with the document and it should be reported to Aspose.Words developers.
        :raises System.IO.IOException: There is an input/output exception.
    ...
    def save(self, file_name: str, save_options: aspose.words.saving.SaveOptions) -> aspose.words.saving.SaveOutputParameters:
        ...
        :param file_name: The name for the document. If a document with the
                          specified file name already exists, the existing document is overwritten.
        :param save_options: Specifies the options that control how the document is saved. Can be null.
        :returns: Additional information that you can optionally use.'''
        ...
    ...
    def update_word_count(self) -> None:
        ...
        **UpdateWordCount** recalculates and updates Characters, Words and Paragraphs
        properties in the :attr:`Document.built_in_document_properties` collection of the **Document**.
...
class DocumentBuilder:
    ...
    **DocumentBuilder** is a "facade" for the complex structure of **Document** and allows
    ...
    Create a **DocumentBuilder** and associate it with a :attr:`DocumentBuilder.document`.
    ...
    def __init__(self):
        ...
        Creates a new **DocumentBuilder** object and attaches it to a new :attr:`DocumentBuilder.document` object.'''
        ...
    ...
    def __init__(self, doc: aspose.words.Document):
        ...
        Creates a new **DocumentBuilder** object, attaches to the specified :attr:`DocumentBuilder.document` object.
    ...
    def insert_field(self, field_code: str, field_value: str) -> aspose.words.fields.Field:
        ...
        :param field_code: The field code to insert (without curly braces).
        :param field_value: The field value to insert. Pass null for fields that do not have a value.
        :returns: A :class:`aspose.words.fields.Field` object that represents the inserted field.'''
        ...
    ...
    def insert_ole_object_as_icon(self, file_name: str, is_linked: bool, icon_file: str, icon_caption: str) -> aspose.words.drawing.Shape:
        ...
        :param file_name: Full path to the file.
        :param is_linked: If true then linked OLE object is inserted otherwise embedded OLE object is inserted.
        :param icon_file: Full path to the ICO file. If the value is null, Aspose.Words will use a predefined image.
        :param icon_caption: Icon caption. If the value is null, Aspose.Words will use the file name.
        :returns: Shape node containing Ole object and inserted at the current Builder position.'''
        ...
    ...
    def insert_ole_object_as_icon(self, stream: io.BytesIO, prog_id: str, icon_file: str, icon_caption: str) -> aspose.words.drawing.Shape:
        ...
        :param prog_id: ProgId of OLE object.
        :param icon_file: Full path to the ICO file. If the value is null, Aspose.Words will use a predefined image.
        :param icon_caption: Icon caption. If the value is null, Aspose.Words will use the a predefined icon caption.
        :returns: Shape node containing Ole object and inserted at the current Builder position.'''
        ...
    ...
    def end_row(self) -> aspose.words.tables.Row:
        ...
        Call **EndRow** to end a table row. If you call :meth:`DocumentBuilder.insert_cell` immediately
...
class DocumentVisitor:
    ...
    1. Call :meth:`Node.accept` on the **Node** that
...
class FileFormatUtil:
    ...
    def extension_to_save_format(self, extension: str) -> aspose.words.SaveFormat:
        ...
        :raises System.ArgumentNullException: Throws if the parameter is null.'''
        ...
...
class HeaderFooter(aspose.words.Story):
    ...
    **HeaderFooter** is a section-level node and can only be a child of **Section**.
    There can only be one **HeaderFooter** or each :attr:`HeaderFooter.header_footer_type` in a **Section**.
...
class HeaderFooterCollection(aspose.words.NodeCollection):
    '''Provides typed access to :class:`HeaderFooter` nodes of a **Section**.
...
class IHyphenationCallback:
    ...
    def request_dictionary(self, language: str) -> None:
        ...
        using:meth:`Hyphenation.register_dictionary` with null value.
...
class InlineStory(aspose.words.CompositeNode):
    ...
    **InlineStory** is a container for block-level nodes :class:`Paragraph` and :class:`aspose.words.tables.Table`.
...
class Node:
    ...
    * Implements access to sibling nodes.'''
    ...
    def get_ancestor(self, ancestor_type: aspose.words.NodeType) -> aspose.words.CompositeNode:
        ...
        :returns: The ancestor of the specified type or null if no ancestor of this type was found.'''
        ...
...
class NodeCollection:
    ...
    **NodeCollection** is returned by :meth:`CompositeNode.get_child_nodes`
    ...
    **NodeCollection** can be "flat" and contain only immediate children of the node it was created
    ...
    def add(self, node: aspose.words.Node) -> None:
        ...
        :raises System.NotSupportedException: The **NodeCollection** is a "deep" collection.'''
        ...
...
class NodeList:
    ...
    **NodeList** is returned by :meth:`CompositeNode.select_nodes` and contains a collection
    of nodes matching the XPath query.
    
    **NodeList** supports indexed access and iteration.
    
    **NOTE**: Treat the **NodeList** collection as a "snapshot" collection. **NodeList** starts
...
class PageSetup:
    ...
    **PageSetup** object contains all the page setup attributes of a section
    ...
    def orientation(self) -> aspose.words.Orientation:
        ...
        Changing **Orientation** swaps :attr:`PageSetup.page_width` and :attr:`PageSetup.page_height`.'''
        ...
...
class Paragraph(aspose.words.CompositeNode):
    ...
    def __init__(self, doc: aspose.words.DocumentBase):
        ...
        To append **Paragraph** to the document use InsertAfter or InsertBefore
    ...
    def append_field(self, field_code: str, field_value: str) -> aspose.words.fields.Field:
        ...
        :param field_code: The field code to append (without curly braces).
        :param field_value: The field value to append. Pass null for fields that do not have a value.
        :returns: A :class:`aspose.words.fields.Field` object that represents the appended field.'''
        ...
    ...
    def insert_field(self, field_type: aspose.words.fields.FieldType, update_field: bool, ref_node: aspose.words.Node, is_after: bool) -> aspose.words.fields.Field:
        ...
        :param update_field: Specifies whether to update the field immediately.
        :param ref_node: Reference node inside this paragraph (if refNode is null, then appends to the end of the paragraph).
...
class Section(aspose.words.CompositeNode):
    ...
    **Section** can have one :attr:`Section.body` and maximum one :class:`HeaderFooter`
    of each :class:`HeaderFooterType`. **Body** and **HeaderFooter** nodes
    ...
    section properties use methods of the **Sections** object.
    
    To copy and insert just content of the section excluding the section break
    and section properties use **AppendContent** and **PrependContent** methods.'''
...
class TabStop:
    ...
    :attr:`TabStop.alignment` to ``TabAlignment.Clear``.
...
class TabStopCollection(aspose.words.InternableComplexAttr):
    ...
    def after(self, position: float) -> aspose.words.TabStop:
        ...
        :returns: A tab stop object or null if a suitable tab stop was not found.'''
        ...
...
class TextColumn:
    '''Represents a single text column. **TextColumn** is a member of the :class:`TextColumnCollection` collection.
...
class Watermark:
    ...
    def set_text(self, text: str) -> None:
        ...
        :raises System.ArgumentNullException: Throws when the text is null.'''
        ...
    ...
    def set_text(self, text: str, options: aspose.words.TextWatermarkOptions) -> None:
        ...
        If :class:`TextWatermarkOptions` is null, the watermark will be set with default options.'''
        ...
    ...
    def set_image(self, image_path: str, options: aspose.words.ImageWatermarkOptions) -> None:
        ...
        :raises System.ArgumentNullException: Throws when the path is null.
        
        If :class:`ImageWatermarkOptions` is null, the watermark will be set with default options.'''
        ...
...
class ImportFormatMode:
    ...
    **KeepSourceFormatting** option allows to make sure the imported content looks the same
