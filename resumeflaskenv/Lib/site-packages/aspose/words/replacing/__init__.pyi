...
class ReplacingArgs:
    ...
    def group_name(self) -> str:
        ...
        When group name is null, :attr:`ReplacingArgs.group_index` is used to identify the group.
    ...
    def group_index(self) -> int:
        ...
        :attr:`ReplacingArgs.group_index` has effect only when :attr:`ReplacingArgs.group_name` is null.
