...
class CertificateHolder:
    ...
    **CertificateHolder** can be created by static factory methods only.
    ...
    def create(self, cert_bytes: bytes, password: str) -> aspose.words.digitalsignatures.CertificateHolder:
        ...
        :returns: An instance of CertificateHolder
        
        :raises Org.BouncyCastle.Security.InvalidParameterException: Thrown if **certBytes** is null
        :raises Org.BouncyCastle.Security.InvalidParameterException: Thrown if **password** is null
    ...
    def create(self, file_name: str, password: str) -> aspose.words.digitalsignatures.CertificateHolder:
        ...
        :raises Org.BouncyCastle.Security.InvalidParameterException: Thrown if **fileName** is null
        :raises Org.BouncyCastle.Security.InvalidParameterException: Thrown if **password** is null
        :raises System.Security.SecurityException: Thrown if PKCS12 store contains no aliases
        :raises System.IO.IOException: Thrown if there is wrong password or corrupted file.'''
        ...
