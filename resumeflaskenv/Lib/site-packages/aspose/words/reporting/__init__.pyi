...
class JsonDataLoadOptions:
    ...
    def exact_date_time_parse_format(self) -> str:
        ...
        * When :attr:`JsonDataLoadOptions.exact_date_time_parse_format` is **null**, the ISO-8601 format and all date-time formats
    ...
    def exact_date_time_parse_formats(self) -> Iterable[str]:
        ...
        * When :attr:`JsonDataLoadOptions.exact_date_time_parse_formats` is **null**, the ISO-8601 format and all date-time formats
          supported for the current, English USA, and English New Zealand cultures are used additionally in
          the mentioned order.
...
class ReportingEngine:
    ...
    def build_report(self, document: aspose.words.Document, data_source: object, data_source_name: str) -> bool:
        ...
        passing null or use the:meth:`ReportingEngine.build_report` overload.
