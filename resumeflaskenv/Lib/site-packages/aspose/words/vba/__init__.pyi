...
class VbaReference:
    ...
    def type(self) -> aspose.words.vba.VbaReferenceType:
        '''Gets :class:`VbaReferenceType` object that indicates the type of reference that a VbaReference object represents.'''
        ...
