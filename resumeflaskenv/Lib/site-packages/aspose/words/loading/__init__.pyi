...
class HtmlLoadOptions(aspose.words.loading.LoadOptions):
    ...
    def __init__(self, load_format: aspose.words.LoadFormat, password: str, base_uri: str):
        ...
        :param password: The password to open an encrypted document. Can be null or empty string.
        :param base_uri: The string that will be used to resolve relative URIs to absolute. Can be null or empty string.'''
        ...
...
class LoadOptions:
    ...
    def font_settings(self) -> aspose.words.fonts.FontSettings:
        ...
        If set to null, default static font settings :attr:`aspose.words.fonts.FontSettings.default_instance` will be used.
    ...
    def flat_opc_xml_mapping_only(self) -> bool:
        ...
        This option is paired with :attr:`aspose.words.saving.SaveOptions.flat_opc_xml_mapping_only`.
