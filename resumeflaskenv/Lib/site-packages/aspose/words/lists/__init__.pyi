...
class ListCollection:
    ...
    def get_list_by_list_id(self, list_id: int) -> aspose.words.lists.List:
        ...
        :returns: Returns the list object. Returns null if a list with the specified identifier was not found.
...
class ListFormat:
    ...
    def remove_numbers(self) -> None:
        ...
        Calling this method is equivalent to setting the :attr:`ListFormat.list` property to null.'''
        ...
...
class ListLevel:
    ...
    def get_effective_value(self, index: int, number_style: aspose.words.NumberStyle, custom_number_style_format: str) -> str:
        ...
        :raises System.ArgumentException: customNumberStyleFormat is null or empty when the numberStyle is custom.-or-
